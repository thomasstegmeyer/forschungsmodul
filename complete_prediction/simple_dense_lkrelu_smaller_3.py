...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc6 = nn.Linear(150,150)
        self.fc7 = nn.Linear(150,150)
        self.fc8 = nn.Linear(150,100)
        self.fc9 = nn.Linear(100,84)
        self.fc10 = nn.Linear(84, 9)
...
torch.onnx.export(Net(),x,"simple_dense_smaller_3_architecture.onnx",input_names = ["damages"],output_names = ["measures"])


processes = []

processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_3_oneCycle/e2simple_dense_smaller_3_lr_1e-2/extended_dense_lr_1e-1",1e-2,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_3_oneCycle/e2simple_dense_smaller_3_lr_5e-2/extended_dense_lr_1e-1",5e-2,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_3_oneCycle/e3simple_dense_smaller_3_lr_1e-3/extended_dense_lr_1e-1",1e-3,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_3_oneCycle/e3simple_dense_smaller_3_lr_5e-3/extended_dense_lr_1e-1",5e-3,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_3_oneCycle/e4simple_dense_smaller_3_lr_1e-4/extended_dense_lr_1e-1",1e-4,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_3_oneCycle/e4simple_dense_smaller_3_lr_5e-4/extended_dense_lr_1e-1",5e-4,0.95)))
