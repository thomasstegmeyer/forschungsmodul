...
for file in os.listdir():
    if not file.startswith("normalize"):
        ...
        std_volume += (measures[0]-mean_volume)**2/60000
        std_max_x += (measures[1]-mean_max_x)**2/60000
        std_max_y += (measures[2]-mean_max_y)**2/60000
        std_min_y += (measures[3]-mean_min_y)**2/60000
        std_sign_changes += (measures[4]-mean_sign_changes)**2/60000
        std_max_curvature += (measures[5]-mean_max_curvature)**2/60000
        std_min_curvature += (measures[6]-mean_min_curvature)**2/60000
        std_fractal_dimension += (measures[7]-mean_fractal_dimension)**2/60000
        std_skeleton_lengths += (measures[8]-mean_skeleton_lengths)**2/60000
