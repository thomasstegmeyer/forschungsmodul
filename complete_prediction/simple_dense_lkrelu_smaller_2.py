...
class Net(nn.Module):
    ...
    def forward(self, input):
        ...
        output = F.leaky_relu(self.fc10(r8))
...
torch.onnx.export(Net(),x,"simple_dense_smaller_2_architecture.onnx",input_names = ["damages"],output_names = ["measures"])


processes = []

processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_2_oneCycle/e2simple_dense_smaller_2_lr_1e-2/extended_dense_lr_1e-1",1e-2,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_2_oneCycle/e2simple_dense_smaller_2_lr_5e-2/extended_dense_lr_1e-1",5e-2,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_2_oneCycle/e3simple_dense_smaller_2_lr_1e-3/extended_dense_lr_1e-1",1e-3,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_2_oneCycle/e3simple_dense_smaller_2_lr_5e-3/extended_dense_lr_1e-1",5e-3,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_2_oneCycle/e4simple_dense_smaller_2_lr_1e-4/extended_dense_lr_1e-1",1e-4,0.95)))
processes.append(Process(target = train_networks, args = (Net(),"test_all_unnormalized/simple_dense_smaller_2_oneCycle/e4simple_dense_smaller_2_lr_5e-4/extended_dense_lr_1e-1",5e-4,0.95)))
