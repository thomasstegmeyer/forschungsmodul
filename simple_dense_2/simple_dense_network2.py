...
net = torch.load("simple_dense_2_epoch_2_min_validation_loss_lr0_00005_gamma_095.pkl")
...
for e in range(2,epochs):
    ...
    if min_valid_loss > valid_loss:
        ...
        # Saving State Dict
        path = "simple_dense_2_epoch_" + str(e+1) + "_min_validation_loss_lr0_00005_gamma_095.pkl"
        torch.save(net, path)
    scheduler.step()