...
for e in range(epochs):
    ...
    np.savetxt("simple_conv_adam_00001_095.txt",[epochs_done,traininglosses,validationlosses])
    ...
    plt.xlabel("Epochs")
    plt.ylabel("MSE loss")
    plt.savefig("simple_conv_adam_00001_095.png")
    plt.close()
    ...
    if min_valid_loss > valid_loss:
        ...
        # Saving State Dict
        path = "simple_conv_adam_" + str(e+1) + "_min_validation_loss_lr0_00001_gamma_095.pkl"
        torch.save(net, path)
    scheduler.step()
