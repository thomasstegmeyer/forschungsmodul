...
net = torch.load("simple_dense_4_epoch_1_min_validation_loss_lr0_0001_gamma_098.pkl")
...
for e in range(epochs):
    ...
    plt.xlabel("Epochs")
    plt.ylabel("MSE loss")
    plt.savefig("simple_dense_4_progress.png")
    plt.close()
    ...
    if min_valid_loss > valid_loss:
        ...
        # Saving State Dict
        path = "simple_dense_4_epoch_" + str(e+1) + "_min_validation_loss_lr0_0001_gamma_098.pkl"
        torch.save(net, path)
    scheduler.step()